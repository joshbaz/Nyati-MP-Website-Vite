          ...
          <Box className="w-max absolute left-0 bottom-20">
            ...
            >
              ...
              >
                ...
                <Stack className="flex flex-row space-x-3">
                  ...
                  <Stack direction="row" className="space-x-2">
                    <Buttons className="flex w-max px-2 py-2 items-center justify-center space-x-2 rounded-full relative bg-[#706e72]">
